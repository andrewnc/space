...
const WeatherCard = () => {
    ...
    useEffect(() => {
        ...
        fetch(url)
            ...
            .then(data => setWeatherObj(data.soles[0]))
    }, []);
        ...
        return (
            <div className ="weather-wrapper">
                <div className ="weather-card">
                    ...
                    <h1 className = "temp-val">low {CtoF(weatherObj.min_temp)}º</h1>
                    <h1 className = "temp-val">high {CtoF(weatherObj.max_temp)}º</h1>
                </div>
                <div className ="weather-card">
                    <p>C</p>
                    <div className ="weather-icon">
                    ...
                    <h1 className = "temp-val">low {weatherObj.min_temp}º</h1>
                    <h1 className = "temp-val">high {weatherObj.max_temp}º</h1>
                </div>
            </div>
            // <div className="mars-weather">
            //     <div className="date">
            //         <div className="mars-date">Mars Sol: {weatherObj.sol}</div>
            //         <div className="earth-date">Earth Date: {weatherObj.terrestrial_date}</div>
            //     </div>
            //     <div className="temperatures">
            //         <div className="farenheit">
            //             <div className="temp-high">{CtoF(weatherObj.max_temp)}F</div>
            //             <div className="temp-low">{CtoF(weatherObj.min_temp)}F</div>
            //         </div>
            //         <div className="celsius">
            //             <div className="temp-high">{weatherObj.max_temp}C</div>
            //             <div className="temp-low">{weatherObj.min_temp}C</div>
            //         </div>
            //     </div>
            // </div>
        )
